...
export default function JudgePortal() {
  ...
  if (activeAssignmentId) {
    ...
    return (
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24, flexDirection: isMobile ? 'column' : 'row', gap: isMobile ? 16 : 0 }}>
          <div>
            <h2 data-mobile-h1 style={{ fontSize: 24, marginBottom: 4 }}>{submission?.project_title || 'Untitled'}</h2>
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
        <h2 data-mobile-h1 style={{ fontSize: 24 }}>Judge Portal</h2>
